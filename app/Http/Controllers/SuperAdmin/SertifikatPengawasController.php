...
class SertifikatPengawasController extends Controller
{
    ...
    public function download(SertifikatPengawas $sertifikatPengawa)
    {
        ...
        if (!Storage::disk('public')->exists($filePath)) {
            ...
            return redirect()->back()->with('error', 'File sertifikat tidak ditemukan. Silahkan generate ulang sertifikat.');
        }
    ...
    public function generateAll()
    {
        try {
            ...
            if ($ungeneratedCertificates->isEmpty()) {
                return redirect()->back()->with('error', 'Tidak ada sertifikat yang perlu digenerate.');
            }
