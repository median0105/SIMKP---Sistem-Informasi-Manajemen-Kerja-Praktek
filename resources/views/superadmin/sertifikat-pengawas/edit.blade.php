    ...
    <div class="py-8 bg-gradient-to-br from-unib-blue-50 to-gray-50 min-h-screen">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-unib-blue-100">
                ...
                {{-- Card Body --}}
                <div class="p-6">
                    <form method="POST" action="{{ route('superadmin.sertifikat-pengawas.update', $sertifikatPengawa) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        @if($sertifikatPengawa->is_generated)
                            <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 px-6 py-4 rounded-r-lg shadow-md flex items-center">
                                <i class="fas fa-exclamation-triangle mr-3 text-yellow-500"></i>
                                <div>
                                    <p class="font-medium">Sertifikat sudah Dicetak</p>
                                    <p class="text-sm mt-1">Perubahan data tidak akan mempengaruhi file PDF yang sudah dicetak. Jika perlu mengubah data, hapus sertifikat dan buat ulang.</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit"
                                ...
                                <i class="fas fa-save mr-2"></i>Update Sertifikat
                            </button>
                        </div>
                    </form>
                </div>
