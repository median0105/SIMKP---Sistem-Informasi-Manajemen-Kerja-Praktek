    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-6">
                    <a href="{{ route('superadmin.kuisioner_pengawas_questions.create') }}" class="bg-unib-blue-600 hover:bg-unib-blue-700 text-white px-4 py-2 rounded-md inline-flex items-center">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        @forelse($questions as $question)
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <a href="{{ route('superadmin.kuisioner_pengawas_questions.edit', $question) }}" class="text-unib-blue-600 hover:text-unib-blue-800 mr-2">Edit</a>
                                    <form action="{{ route('superadmin.kuisioner_pengawas_questions.destroy', $question) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus pertanyaan ini?');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-8 text-gray-500">Belum ada pertanyaan kuisioner pengawas.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
