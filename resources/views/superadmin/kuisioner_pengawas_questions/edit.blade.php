<x-sidebar-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('superadmin.kuisioner_pengawas_questions.index') }}" class="text-unib-blue-600 hover:text-unib-blue-800">
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-6">
                <form method="POST" action="{{ route('superadmin.kuisioner_pengawas_questions.update', $question) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="question_text" id="question_text" rows="3"
                                  ...
                                  placeholder="Masukkan pertanyaan kuisioner..." required>{{ old('question_text', $question->question_text) }}</textarea>
