                    ...
                    <form method="POST" action="{{ route('superadmin.kuisioner_pengawas_questions.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="question_text" id="question_text" rows="4"
                                      ...
                                      placeholder="Masukkan pertanyaan kuisioner pengawas..." required>{{ old('question_text') }}</textarea>
                            @error('question_text') 
                        ...
                        <div class="mb-6">
                            ...
                            <select name="type" id="type"
                                ...
                                <option value="qualitative_rating" {{ old('type') === 'qualitative_rating' ? 'selected' : '' }}>Tidak Baik, Kurang Baik, Cukup Baik, Sangat Baik</option>
                            </select>
                            @error('type') 
                                <p class="text-red-500 text-sm mt-2 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="order" id="order" value="{{ old('order', $nextOrder ?? 1) }}"
                                   class="w-full border-gray-300 rounded-lg shadow-sm focus:border-unib-blue-500 focus:ring-unib-blue-500 px-4 py-3 text-base bg-gray-50 cursor-not-allowed" readonly>
                            @error('order') 
                                <p class="text-red-500 text-sm mt-2 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                                </p> 
