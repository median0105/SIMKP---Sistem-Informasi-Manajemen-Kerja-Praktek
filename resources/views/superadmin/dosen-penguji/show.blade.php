        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Mahasiswa yang Di Nilai ({{ $mahasiswa->count() }})</h3>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    @if($mhs->kpTerbaru && $mhs->kpTerbaru->nilai_akhir)
                                        <span class="font-medium text-gray-900">{{ number_format($mhs->kpTerbaru->nilai_akhir, 2) }}</span>
                                    @else
                                        <span class="text-gray-500">-</span>
                                    @endif
                                </td>
