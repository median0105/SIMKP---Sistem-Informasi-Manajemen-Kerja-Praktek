...
<x-sidebar-layout>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-16 text-gray-500 animate-fade-in-up">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <div class="text-lg font-medium text-gray-900 mb-2">Tidak Ada Data Dosen Penguji</div>
                                            <p class="text-base text-gray-600 max-w-md mx-auto">
                                                Data dosen penguji tidak ditemukan untuk filter saat ini.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
    ...
    <style>
        ...
        /* Menghilangkan efek hover yang mengganggu pada baris tabel */
        .table-row-hover {
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tableRows.forEach(row => {
                ...
                row.classList.remove('transform', 'hover:scale-105', 'table-row-hover');
                
                // Tambahkan class untuk transisi yang aman
