...
<div class="login-container grid grid-cols-1 md:grid-cols-2">
    ...
    <div class="hidden lg:flex flex-col justify-center items-center p-8 xl:p-12 2xl:p-16 bg-[#1D3C96] text-white relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-center items-center text-center w-full h-full">
            <img src="{{ asset('storage/logo-unib.png') }}" alt="UNIB Logo" class="w-24 xl:w-28 2xl:w-32 h-auto -mb-4">
            <h1 class="text-2xl xl:text-3xl 2xl:text-4xl font-bold -mt-4">Universitas Bengkulu</h1>
            <p class="mt-1 xl:mt-2 text-base xl:text-lg font-medium">Selamat Datang</p>
            <p class="text-xs xl:text-sm text-blue-200 mt-0.5">Sistem Informasi Manajemen Praktek</p>
    ...
    <div class="form-content w-full max-w-md">
        <div class="glass-effect rounded-2xl shadow-xl p-5 sm:p-7 md:p-8 login-form">
            <!-- Header dengan ikon dan dekorasi -->
            <div class="text-center header-section mb-5 md:mb-6">
                ...
                <p class="mt-1 sm:mt-2 text-gray-600 text-sm">Silakan masuk untuk mengakses sistem</p>
            ...
            <!-- Session Status -->
            @if (session('status'))
                <div class="mb-4 p-3 rounded-lg text-sm text-center bg-green-50 text-green-700 border border-green-200 flex items-center justify-center">
            ...
            <!-- Error Message -->
            @if (session('error'))
                <div class="mb-4 p-3 rounded-lg text-sm text-center bg-red-50 text-red-700 border border-red-200 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            ...
            <!-- Login Form -->
            <form method="POST" action="{{ route('login') }}" class="form-fields space-y-4">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="input-field w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg bg-white focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition @error('email') border-red-400 focus:ring-red-500/20 focus:border-red-400 @enderror"
                        >
                    </div>
                    @error('email')
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="input-field w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg bg-white focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition @error('password') border-red-400 focus:ring-red-500/20 focus:border-red-400 @enderror"
                        >
                ...
                <!-- Login Button -->
                <button type="submit"
                    class="w-full bg-gradient-to-r from-blue-600 to-blue-800 text-white py-3 px-4 rounded-xl hover:from-blue-700 hover:to-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition-all duration-200 hover:scale-[1.01] font-medium text-base shadow-lg">
                    Masuk
                </button>
