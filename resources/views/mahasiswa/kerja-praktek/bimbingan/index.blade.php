        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if(!$kerjaPraktek)
                ...
                <div class="bg-white rounded-lg shadow p-6 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Belum Ada Kerja Praktek</h3>
                    <p class="text-gray-600 mb-4">Anda perlu mengajukan kerja praktek terlebih dahulu sebelum dapat melakukan bimbingan.</p>
